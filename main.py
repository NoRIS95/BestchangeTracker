...
async def run_programm():
    ...
    change_manager, google_sheets_observer = await asyncio.gather(task_change_manager, task_google_sheets_observer)
    await asyncio.create_task(change_manager.register_observer(google_sheets_observer))
